# RC SOW Flutter v18.2 — Fusion Edit Handoff

Use this project as the editable source for the next Fusion AI update. Do not rebuild from scratch and do not change the Android application/package identity.
