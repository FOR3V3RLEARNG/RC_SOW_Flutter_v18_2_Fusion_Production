...
# Operational form structure is compiled from the source-derived schema registry.
# Editable organisation templates are managed in the private Supabase template bucket
# and are intentionally not embedded in APK/source artifacts.
...
- private editable templates are managed through Admin Template Studio / Supabase storage
