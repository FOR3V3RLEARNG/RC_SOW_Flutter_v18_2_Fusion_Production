...
class _ControlScreenState extends State<ControlScreen> {
  ...
  static const modules = <_ControlModule>[
    _ControlModule('Work Plan', 'workPlan', 'Plan', Icons.calendar_view_week_outlined),
    _ControlModule('Document Checklist', 'documentChecklist', 'Plan', Icons.task_alt_outlined),
    _ControlModule('Monitoring Checklist', 'monitoring', 'Quality', Icons.fact_check_outlined),
    _ControlModule('Site Visits', 'siteVisit', 'Delivery', Icons.location_on_outlined),
    _ControlModule('Daily Site Log', 'dailyLog', 'Delivery', Icons.menu_book_outlined),
    _ControlModule('Material Request', 'materialRequest', 'Delivery', Icons.inventory_2_outlined),
    _ControlModule('Consumables Form', 'consumables', 'Delivery', Icons.handyman_outlined),
    _ControlModule('Inventory Tracker', 'inventory', 'Delivery', Icons.warehouse_outlined),
    _ControlModule('Notice of Completion', 'notice', 'Close-out', Icons.verified_outlined),
    _ControlModule('Payment Submission', 'payment', 'Finance', Icons.payments_outlined),
  ];
    ...
    return RefreshIndicator(
      ...
      child: FutureBuilder<List<ProductionRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          final attention = records.where((record) => record.needsAttention).length;
          ...
          return ListView(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('Control of Works', style: theme.textTheme.headlineMedium),
                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (_) => const [
                      PopupMenuItem(value: 'xlsx-share', child: Text('Share Excel')),
                      PopupMenuItem(value: 'xlsx-save', child: Text('Save Excel')),
                      PopupMenuItem(value: 'pdf-share', child: Text('Share PDF')),
              ...
              Card(
                color: theme.colorScheme.primaryContainer.withValues(alpha: .34),
                child: Padding(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      _MetricChip(label: '$open open', icon: Icons.play_arrow_rounded),
                      _MetricChip(
              ...
              SingleChildScrollView(
                ...
                child: SegmentedButton<String>(
                  segments: const ['All', 'Plan', 'Delivery', 'Quality', 'Close-out', 'Finance']
  ...
  Future<void> _openModule(_ControlModule module) async {
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => _ProductionModuleScreen(
          state: widget.state,
          module: module,
        ),
      ),
...
class _ProductionModuleScreenState extends State<_ProductionModuleScreen> {
  ...
  Future<List<ProductionRecord>> _load() async {
    final all = await widget.state.repository.productionRecords(widget.state.profile!);
    return all.where((record) => record.eventType == widget.module.eventType).toList();
  }
          ...
          if (template != null)
            PopupMenuButton<String>(
              ...
              itemBuilder: (_) => const [
                ...
                PopupMenuItem(value: 'share', child: Text('Share / email template')),
              ],
            ),
        ],
      ),
              ...
              children: [
                ...
                if (snapshot.connectionState != ConnectionState.waiting &&
                  ...
                  const Padding(
                    ...
                    child: Center(child: Text('No records yet. Tap Add record.')),
                  ),
                ...records.map(
                  (record) => Card(
                    child: ListTile(
