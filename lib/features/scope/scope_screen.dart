...
class _ScopeScreenState extends State<ScopeScreen>
      ...
      children: [
        const Padding(
          ...
          child: RcPageHeading(
            ...
            subtitle:
                'Capture the house, verify roof geometry, prepare the beneficiary record and preserve evidence in one guided flow.',
          ),
        ),
        Padding(
  ...
  Future<void> _persistScope(String status) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Scope could not be saved: $e')));
    }
  }

  Widget roofDrawing() => ListView(
    padding: const EdgeInsets.fromLTRB(16, 16, 16, 110),
    children: [
      Card(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Gable', 'Hip', 'Shed', 'Intersecting']
  ...
  Widget measureField(
    ...
    child: TextFormField(
      ...
      onChanged: (v) {
        ...
        if (d != null && d > 0) setState(() => changed(d));
      },
    ),
  );
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: emphasize ? RcColors.brand : RcColors.ink,
              ),
            ),
          ],
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              for (final label in [
                ...
                Text(
                  label,
                  style: const TextStyle(fontSize: 11, color: RcColors.muted),
                ),
              ],
  ...
  Widget printLine(String k, String v) => Padding(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text(
                'Photos, signed scope documents, drawings and approved PDFs belong here. Essential field workflow remains usable even when no media is attached.',
              ),
            ],
          ),
        ),
          ...
          child: pw.Column(
            ...
            children: [
              ...
              for (final label in [
                ...
                'Regional Supervisor',
                'Construction Specialist',
              ]) ...[pw.Divider(), pw.Text(label), pw.SizedBox(height: 18)],
            ],
          ),
        ),
      ),
...
class _ScopeProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label:
          'Scope form step ${index + 1} of ${labels.length}: ${labels[index]}',
      child: Row(
        children: [
...
class RoofDiagram extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AspectRatio(
    aspectRatio: 1.55,
    child: CustomPaint(
      painter: RoofPainter(type: type, m: m, showGrid: showGrid),
...
class RoofPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final left = size.width * .18,
        right = size.width * .82,
        ground = size.height * .78,
        wallTop = size.height * .55,
        ridgeY = size.height * .25,
        cx = size.width / 2;
    ...
    if (type == 'Shed') {
      ...
      if (type == 'Intersecting') {
        canvas.drawLine(
          Offset(cx, ridgeY),
          Offset(cx + size.width * .16, wallTop + 20),
          line,
        );
      }
    }
    ...
    final tp = TextPainter(
      text: TextSpan(
        text: 'Rise ${m.ridgeRiseFt.toStringAsFixed(2)} ft',
    ...
    tp.paint(
      canvas,
      Offset(right + 26, (wallTop + ridgeY) / 2 - tp.height / 2),
    );
    final wp = TextPainter(
      text: TextSpan(
        text: '${m.widthFt.toStringAsFixed(1)} ft',
        style: const TextStyle(
          color: RcColors.ink,
          fontSize: 11,
          fontWeight: FontWeight.w800,
