...
Field Mode: larger targets, fewer metadata, phone/outdoor/one-hand optimized.
Review Mode: denser information, tablet/desktop, master/detail, persistent filters and batch review.

### Control of Works

Redesign as five information layers:
1. Page identity + New Control
2. Production Pulse
3. Lifecycle/phase rail
4. Completion/Payment lifecycle commands
5. Workflow modules
...
Phase filter:
All / Plan / Delivery / Quality / Close-out / Finance, with counts only when useful.
...
5. Plywood/T1-11
6. Zinc
7. Other (overhang, bracing, collars, veranda, gutters)
...
Every write resolves to one of:
✓ Saved
☁ Synced
↻ Syncing
...
1. subtle hope-rainbow arc appears
2. roof repair lines assemble
3. hammer finishes the roof
4. subtle completion shine
5. house smiles wider / proud repaired state
6. professional title animates in:
...
A. Existing Design Extraction
B. UX Audit
C. Enhanced Product Architecture
D. RC SOW Design DNA
E. Mobile Design System
F. Control of Works
G. Scope House → Roof → Print → Files
H. New Control
I. Inventory Tracker
J. House Command
K. Evidence System
...
N. Collaboration
O. Tablet Review Mode
P. Accessibility / High Contrast / Text Scale
Q. P0–P3 Functionality Enhancements
R. Component Specification
S. Final coherent screen family
...
4. Cohesion
5. Originality
6. Flutter/Material 3 feasibility
7. Trust
